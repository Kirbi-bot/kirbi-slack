module.exports = function (Kirbi) {
	...
	function slackMessageCb (output, msg, expires, delCalling) {
		...
		if (typeof output === 'object') {
			...
			if (typeof output.embed.image === 'object') reformatted.attachments[0].image_url = output.embed.image.url;
			if (typeof output.embed.thumbnail === 'object') reformatted.attachments[0].thumb_url = output.embed.thumbnail.url;
